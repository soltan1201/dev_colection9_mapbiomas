...
class processo_filterTemporal(object):
    ...
    options = {
            'output_asset': 'projects/mapbiomas-workspace/AMOSTRAS/col9/CAATINGA/POS-CLASS/Temporal/',
    ...
    def __init__(self):
        ...
        self.ordem_exec_first = [4,3,21] #
        self.ordem_exec_last = [4,3,21]  # 29
        self.ordem_exec_middle = [4,3,21,33] # ,33, 22,      
    ...
    def applyTemporalFilter(self, id_bacias): 
        ...
        name_imgClass = 'filterSP_BACIA_'+ id_bacias  + "_V" + str(self.versInput )
        ...
        name_toexport = 'filterTP_BACIA_'+ str(id_bacias) + "_V" + str(self.versionTP)
...
# listaNameBacias = [
#     '741', '7421', '7422', '744', '745', '746', '7492', '751', '752', '753', '755', '758', '759', '7621', '7622', '764', '765', '766', '767', '771', '772'
# ]
