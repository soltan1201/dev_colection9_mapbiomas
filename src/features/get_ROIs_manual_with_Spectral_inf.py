...
class ClassMosaic_indexs_Spectral(object):
    ...
    options = {
        ...
        'outAssetROIs': 'projects/mapbiomas-workspace/AMOSTRAS/col8/CAATINGA/ROIs/coletaROIsv7N2manual',
        'inAssetROIsPolg': 'projects/mapbiomas-workspace/AMOSTRAS/col7/CAATINGA/ROIsXBaciasManual',
    ...
    def iterate_bacias(self, nomeBacia):
        ...
        for anoCount in [2016,2021]:            
            print("loading yyear ", anoCount)
            bandActiva = 'classification_' + str(anoCount)
            nameFeat = 'pol_manual_' + nomeBacia + "_" + str(anoCount)
            try:
                print("path" , self.options['inAssetROIsPolg'] + '/' + nameFeat)
                featROIsPol = ee.FeatureCollection(self.options['inAssetROIsPolg'] + '/' + nameFeat)
                ...
                # sys.exit()
                name_exp = str(nomeBacia) + "_" + str(anoCount) +"_man"  
